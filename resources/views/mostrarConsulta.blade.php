...
@stop
@section('contenido')
				<a href="{{url('/registrarConsulta')}}" class="btn btn-primary">Agregar Nueva Consulta
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="btn btn-danger btn-xs" href="{{url('/eliminarConsulta')}}/{{$c->id}}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>Eliminar</a>
							</td>
							<td>
							...
							<td>
							<a href="{{url('/PDFReceta')}}/{{$c->id_paciente}}"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></a>
							</td>
								@endforeach
						</tr>
